<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="EditableXmlAttributes.ascx.cs" Inherits="EPiServer.Templates.Alloy.Plugins.LanguageFileEditor.EditableXmlAttributes" %>
