...
using EPiServer.Templates.Alloy.ScheduledParameterJob.Extensions;

namespace EPiServer.Templates.Alloy.ScheduledParameterJob.ExampleJob
{
    [ScheduledPlugInWithParameters(
        ...
        DefinitionsAssembly = "EPiServer.Templates.Alloy"
    )]
    public class SampleParameterJob : ScheduledJob
    {
        public static string Execute()
        {
            var descriptor = PlugInDescriptor.Load("EPiServer.Templates.Alloy.ScheduledParameterJob.ExampleJob.SampleParameterJob", "EPiServer.Templates.Alloy");
